...
def show_vid():      
    ...
    bounding_box = cv2.CascadeClassifier('/Users/fliang/Desktop/haarcascade_frontalface_default.xml')
    ...
    cv2.imshow('Video', cv2.resize(frame1,(1200,860)))
...
def show_vid2():
    ...
    lmain3.configure(text=emotion_dict[show_text[0]],font=('Times New Roman',45,'bold'))
    
    lmain2.configure(image=imgtk2)
    lmain2.after(10, show_vid2)
    
    cv2.imshow('Emoji', frame2)
    #cv2.imshow('Emoji', cv2.resize(frame2,(500,400),interpolation = cv2.INTER_CUBIC))
...
if __name__ == '__main__':
    ...
    root.title("Photo To Spongebob")            
    root.geometry("1400x900+100+10") 
    root['bg']='white'
    exitbutton = Button(root, text='Quit',fg="red",command=root.destroy,font=('Times New Roman',25,'bold')).pack(side = BOTTOM)
